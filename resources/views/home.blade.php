...
<!-- jQuery -->
<script src="{{ asset('import/jquery/dist/jquery.min.js') }}"></script>
<!-- Bootstrap -->
<script src="{{ asset('import/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
<!-- FastClick -->
<script src="{{ asset('import/fastclick/lib/fastclick.js') }}"></script>
<!-- NProgress -->
<script src="{{ asset('import/nprogress/nprogress.js') }}"></script>
